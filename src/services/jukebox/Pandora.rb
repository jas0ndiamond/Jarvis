...
class Pandora < Service
  ...
  def initialize(app = nil, params = {})
    ...
    @name = config["name"]
    @jarvis_user = config["jarvis_user"] 
    ...
    @config_file = File.expand_path("../tmp/pianobar/#{@jarvis_user}/#{@name}/config")
...
#    raise "Could not link config file" unless system("ln -fs #{@config_file} #{@pianobar_symlink}")
    ...
    @pid = fork do
      ...
      #don't care about pianobar output
